...
$(function(){
  ...
  .then(function(values){
    ...
    options.hotels.forEach(makeOption, $hotelSelect);
    options.restaurants.forEach(makeOption, $restaurantSelect);
    options.activities.forEach(makeOption, $activitySelect);
